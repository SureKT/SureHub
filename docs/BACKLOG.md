...
Lo *pendiente* y lo *en curso*. El registro de lo hecho es el `git log`.
La sesión de Claude Code (server, Remote Control) mantiene este fichero: pedir
"apunta esto al backlog" o "marca X hecho" desde el móvil.
